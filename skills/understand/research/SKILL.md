---
name: research
description: Document and explain the codebase as it exists, producing a research markdown file under agents_output/. Only use when the user explicitly requests it (e.g. /research).
---
